...
from versatileimagefield.serializers import VersatileImageFieldSerializer #used for VersatileImageField
...
class PostDetailSerializer(PostSerializer):
    ...
    hero_image = VersatileImageFieldSerializer(
        sizes=[
            ("full_size", "url"),
            ("thumbnail", "thumbnail__100x100"),
            ("square_crop", "crop__200x200"), #extra image field for detail post
        ],
        read_only=True,
    )
