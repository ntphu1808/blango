...
from django.db.models import Q   #used for User-Based Filtering
from django.utils import timezone # as above
...
class PostViewSet(viewsets.ModelViewSet): #this single class replaces the both classes below
    ...
    def get_queryset(self):
        ...
        #get the period_name parameter from the url through self.kwargs
    ...
    @method_decorator(vary_on_headers("Authorization", "Cookie")) #since the queryset is filtered by each user so the list view has to be differ for each cookie and Authorization header
